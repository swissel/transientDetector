...
class TransientDetector():
    def __init__(self):
        ...
        self.gpibConn = self.rm.open_resource('GPIB1::23::INSTR',read_termination='\r\n')
...
if __name__ == "__main__":
    ...
    #sr.setupLabThresholdScan("D:/LWA-OVRO/TransientRates/May27_VHFBoxes1_VPOL_ThresholdScan_Terminated.csv", minThresholdmV=0.0, maxThresholdmV=100.0)
    #sr.runLabThresholdScan()
    #sr.setupFixedRun(dirc = "D:/LWA-OVRO/TransientRates/")
    sr.runFixedCounter(dirc="D:/LWA-OVRO/TransientRates/", runTimeMinutes=10.0)
    #sr.runFieldThresholdScan(dirc="D:/LWA-OVRO/TransientRates/VHF_Vpol")